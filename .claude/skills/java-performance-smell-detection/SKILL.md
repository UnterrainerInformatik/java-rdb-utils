...
description: Detect potential code-level performance smells in Java - streams, collections, boxing, regex, object creation. Provides awareness, not absolutes - always measure before optimizing. For JPA/database performance, use java-jpa-patterns instead.
license: MIT
metadata:
  author: "Gerald"
...
**For database:** Use `java-jpa-patterns` skill (N+1, lazy loading, pagination)
**For architecture:** Use `java-architecture-review` skill
