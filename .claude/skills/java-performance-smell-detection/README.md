...
- **JPA/Database** - Use `java-jpa-patterns` skill
- **Architecture** - Use `java-architecture-review` skill
...
- `java-jpa-patterns` - Database performance (N+1, pagination)
- `java-code-review` - General code quality
- `java-concurrency-review` - Thread safety and async patterns
