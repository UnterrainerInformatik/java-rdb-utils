...
**Load**: `view .claude/skills/java-design-patterns/SKILL.md`
...
```
> view .claude/skills/java-design-patterns/SKILL.md
...
- `java-solid-principles` - Principles patterns implement
- `clean-code` - Code-level practices
- `java-spring-boot-patterns` - Spring implementations
